...
def main():
    ...
    try:
        ...
        time.sleep(2)  # Wait for passenger details form
        booking.fill_passenger_details(passenger)
        time.sleep(20)  # Wait for final captcha
        booking.handle_final_captcha()
        time.sleep(5)  # Wait for booking confirmation
    except Exception as e:
